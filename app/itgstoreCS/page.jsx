...
import { AI_CHATBOT } from '@/assets/constants/projects'
...
const demoContent = (
  ...
  export default function itgstoreCS() {
    ...
    const firstSection = AI_CHATBOT.FirstSection;
    const secondSection = AI_CHATBOT.SecondSection;
    const thirdSection = AI_CHATBOT.ThirdSection;
    const fourthSection = AI_CHATBOT.FourthSection;
    const fifthSection = AI_CHATBOT.FifthSection;
    const sixthSection = AI_CHATBOT.SixthSection;
    const improvements = AI_CHATBOT.ImprovementSection;
    const summarySection = AI_CHATBOT.SummarySection;
    ...
    <div className='space-y-20'>
      ...
      <section>
        ...
        <div className="relative w-full h-[90vh] "> {/* Adjust height based on needs */}
          <Image
            src={chatbotImg.src}
            alt="AI_CHATBOT image background"
